...
export default function LandingPage() {
  ...
  <div id="features" data-section="features">
      ...
      useInvertedBackground={false}
      features={[
        { icon: Shield, title: "Authenticity Guaranteed", description: "100% genuine Apple products directly sourced." },
        { icon: Zap, title: "Fast Shipping", description: "Get your favorite audio gear delivered in days." },
        { icon: Headphones, title: "Expert Support", description: "Dedicated customer service to help you choose." },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={false}
      faqs={[
        { id: "q1", title: "Are these authentic Apple products?", content: "Yes, all our AirPods are 100% authentic and come in original packaging." },
        { id: "q2", title: "What is the return policy?", content: "We offer a 30-day money-back guarantee on all unopened items." },
        { id: "q3", title: "Do you ship internationally?", content: "Yes, we ship to most major regions worldwide." },
      ]}
  ...
  <div id="footer" data-section="footer">
      <FooterBaseReveal
      columns={[
        { title: "Shop", items: [{ label: "All AirPods", href: "#catalog" }, { label: "Compare", href: "#catalog" }] },
